...
%% Extended Figure 10A: randomly perturb 11 nodes in primary sensory regions
    %% upload data 
load('sourceData_ExtFig10A_HCPD_perturbPrimarySensory.mat')
   ...
   ylim([0 0.5]);
    ...
    for for_grad0=1
        ...
        project_detection_community_boview(grad_0_perturb(:,1),'', schaefer_200_label(1:10242,1)',surfL,1);
    ...
    for for_grad2=1
        ...
        project_detection_community_boview(grad_2_perturb(:,1),'', schaefer_200_label(1:10242,1)',surfL,1);
        BoSurfStatColLim([-0.02 0.03]); colormap((hcp_colormap(:,1:3)));
    end
    for for_grad3=1
        ...
        project_detection_community_boview(grad_3_perturb(:,1),'', schaefer_200_label(1:10242,1)',surfL,1);
        BoSurfStatColLim([-0.02 0.03]); colormap((hcp_colormap(:,1:3)));
    ...
    for for_grad4=1
        ...
        project_detection_community_boview(grad_4_perturb(:,1),'', schaefer_200_label(1:10242,1)',surfL,1);
        BoSurfStatColLim([-0.02 0.03]); colormap((hcp_colormap(:,1:3)));
